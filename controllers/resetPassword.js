...
import clearExpiredResetPasswordTokens from "../helpers/clearExpiredResetPasswordTokens.js"
...
async function resetPassword(req,res)
{
    ...
    {   
        ...
        else
        {
                ...
                <tr>
                    <td style="padding:30px;color:#1f2937;font-size:15px;line-height:1.6;">
                        ...
                        <p style="text-align:center;margin:30px 0;">
                            <a href="${process.env.RESET_PASSWORD_ADDRESS}/${saved.id}" style=" background-color:#F27405; color:#ffffff; text-decoration:none; padding:12px 24px; border-radius:6px; font-weight:bold; display:inline-block; ">Resetuj hasło
                            </a>
                        </p>
                        <p> Jeśli to nie Ty wysłałeś prośbę o zmianę hasła, zignoruj tę wiadomość — Twoje konto pozostanie bezpieczne.
                        </p>
            ...
            title:'Resetowanie hasła aplikacji Notely'
            })
